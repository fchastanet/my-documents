...
Interactive presentations created with Marp. Each presentation is available in both HTML (interactive) and PPTX
(PowerPoint) formats.
...
- **[Understanding AI and Machine Learning](https://devlab.top/presentations/understanding-ai/understanding-ai-and-ml-presentation.html)**
  ( **[PPTX](https://devlab.top/presentations/understanding-ai/understanding-ai-and-ml-presentation.pptx)** |
  **[Marp source code](https://github.com/fchastanet/my-documents/blob/master/marp/understanding-ai/understanding-ai-and-ml-presentation.md)**
  )
...
All presentations are created using [Marp](https://marp.app/), a markdown-based presentation ecosystem that allows us
to:
