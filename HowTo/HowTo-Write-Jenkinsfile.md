...
[Jenkinsfile coding dojo](https://github.com/fchastanet/coding_dojo_jenkins). Moreover it allows you to launch on WSL a
jenkins environment that can be easily upgraded with your preferred plugins.
...
5. [Annotated Jenkinsfiles](/HowTo/HowTo-Write-Jenkinsfile/05-00-Annotated-Jenkinsfiles.md) 5.1.
   [php project with helm push](/HowTo/HowTo-Write-Jenkinsfile/05-01-Annotated-Jenkinsfiles.md) 5.2.
   [javascript project with docker build and S3 push](/HowTo/HowTo-Write-Jenkinsfile/05-02-Annotated-Jenkinsfiles.md)
   5.3. [browser extension build and deployment](/HowTo/HowTo-Write-Jenkinsfile/05-03-Annotated-Jenkinsfiles.md) 5.4.
